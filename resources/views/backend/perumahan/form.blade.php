    ...
    <div class="container-fluid">
        ...
        <div class="card-body bg-white mb-5 shadow-sm rounded d-flex justify-content-between">
            <div class="d-flex" style="align-items: center;">
                <h1 class="h3 text-gray-800 mb-0">{{ $type == 'create' ? 'Tambah' : 'Update' }} Perumahan
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="alamat" class="form-control" id="alamat" placeholder="Alamat Perumahan" cols="30"
                                rows="3" required>{{ $type == 'update' ? $perumahan->address : old('alamat') }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="no_imb"
                                value="{{ $type == 'update' ? $perumahan->no_imb : old('no_imb') }}"
                                placeholder="Nomor IMB Perumahan" id="no_imb" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="nama" class="col-sm-2 col-form-label">No. Hasil Pengujian Air</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="uji_pdam"
                                value="{{ $type == 'update' ? $perumahan->uji_pdam : old('uji_pdam') }}"
                                placeholder="Nomor Hasil Pengujian Air Oleh PDAM" id="uji_pdam" required>
                        </div>
                    </div>
